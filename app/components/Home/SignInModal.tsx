...
const SignInModal = ({ isOpen, closeModal }: SignInModalProps) => {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="relative p-2 w-full max-w-md max-h-full overflow-y-auto">
        <div className="relative bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center p-4 md:p-5 border-b rounded-t  border-gray-200">
            <p className="text-4xl font-semibold cursor-pointer logo pb-8 ">
              Настан<span className="text-accent font-semibold">.мк</span>
            </p>
            <h1 className="text-3xl font-bold p-2">Најави се</h1>
            <h2>
              Се уште не сте член?
          ...
          {/* Content Section - Added Overflow-y-auto */}
